...
/**
 * Gets or Sets DeliveryReportRequested
 */
public enum DeliveryReportRequested {
  ...
  DeliveryReportRequested(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DeliveryReportRequested fromValue(String value) {
    for (DeliveryReportRequested b : DeliveryReportRequested.values()) {
