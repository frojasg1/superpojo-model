...
/**
 * Gets or Sets dnnSelectionMode
 */
public enum DnnSelectionMode {
  ...
  @JsonCreator
  public static DnnSelectionMode fromValue(String value) {
    for (DnnSelectionMode b : DnnSelectionMode.values()) {
