...
public class PDUSessionInformation   {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(networkSlicingInfo, pduSessionID, pduType, sscMode, hPlmnId, servingNetworkFunctionID, ratType, dnnId, dnnSelectionMode, chargingCharacteristics, chargingCharacteristicsSelectionMode, startTime, stopTime, _3gppPSDataOffStatus, sessionStopIndicator, pduAddress, diagnostics, authorizedQoSInformation, subscribedQoSInformation, authorizedSessionAMBR, subscribedSessionAMBR, servingCNPlmnId);
  }
