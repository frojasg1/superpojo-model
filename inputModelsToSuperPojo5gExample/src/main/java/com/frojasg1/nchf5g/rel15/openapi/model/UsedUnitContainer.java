...
public class UsedUnitContainer   {
  ...
  public UsedUnitContainer eventTimeStamps(Date eventTimeStamps) {
  ...
  public Date getEventTimeStamps() {
    return eventTimeStamps;
  }

  public void setEventTimeStamps(Date eventTimeStamps) {
    this.eventTimeStamps = eventTimeStamps;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(serviceId, quotaManagementIndicator, triggers, triggerTimestamp, time, totalVolume, uplinkVolume, downlinkVolume, serviceSpecificUnits, eventTimeStamps, localSequenceNumber, pDUContainerInformation);
  }
