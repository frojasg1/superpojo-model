...
public class ChargingDataResponse   {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(invocationTimeStamp, invocationSequenceNumber, invocationResult, sessionFailover, supportedFeatures, multipleUnitInformation, triggers, pDUSessionChargingInformation, roamingQBCInformation, locationReportingChargingInformation);
  }
