...
public enum InterfaceType {
  ...
  MOBILE_ORIGINATING("MOBILE_ORIGINATING"),
  
  MOBILE_TERMINATING("MOBILE_TERMINATING"),
  
  APPLICATION_ORIGINATING("APPLICATION_ORIGINATING"),
  
  APPLICATION_TERMINATING("APPLICATION_TERMINATING");
