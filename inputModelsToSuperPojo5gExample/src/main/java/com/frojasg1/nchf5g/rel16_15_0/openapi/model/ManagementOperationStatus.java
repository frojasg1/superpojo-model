...
/**
 * Gets or Sets ManagementOperationStatus
 */
public enum ManagementOperationStatus {
  ...
  ManagementOperationStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ManagementOperationStatus fromValue(String value) {
    for (ManagementOperationStatus b : ManagementOperationStatus.values()) {
