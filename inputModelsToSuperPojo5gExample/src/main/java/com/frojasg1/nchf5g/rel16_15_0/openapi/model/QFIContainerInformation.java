...
public class QFIContainerInformation   {
   ...
   **/
  @JsonProperty(value = "3gppChargingId")
  @ApiModelProperty(value = "")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(qFI, reportTime, timeofFirstUsage, timeofLastUsage, qoSInformation, qoSCharacteristics, userLocationInformation, uetimeZone, presenceReportingAreaInformation, rATType, servingNetworkFunctionID, _3gppPSDataOffStatus, _3gppChargingId, diagnostics, enhancedDiagnostics);
  }
