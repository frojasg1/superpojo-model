...
/**
 * Gets or Sets RegistrationMessageType
 */
public enum RegistrationMessageType {
  ...
  RegistrationMessageType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static RegistrationMessageType fromValue(String value) {
    for (RegistrationMessageType b : RegistrationMessageType.values()) {
