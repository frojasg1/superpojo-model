...
public enum SMMessageType {
  ...
  SM_SERVICE_REQUEST("SM_SERVICE_REQUEST"),
  
  DELIVERY("DELIVERY");

  private String value;

  SMMessageType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static SMMessageType fromValue(String value) {
    for (SMMessageType b : SMMessageType.values()) {
